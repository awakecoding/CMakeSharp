...
# <TARGET> <TARGET_BASE> <OBJECT> <OBJECTS> <LINK_LIBRARIES> <FLAGS> <LINK_FLAGS>

set(CMAKE_CSharp_ECHO_ALL "echo \"TARGET: <TARGET> TARGET_BASE: <TARGET_BASE> OBJECT: <OBJECT> OBJECTS: <OBJECTS>")
...
if(NOT CMAKE_CSharp_CREATE_SHARED_LIBRARY)
	set(CMAKE_CSharp_CREATE_SHARED_LIBRARY ${CMAKE_CSharp_ECHO_ALL})
endif()

if(NOT CMAKE_CSharp_CREATE_SHARED_MODULE)
	set(CMAKE_CSharp_CREATE_SHARED_MODULE ${CMAKE_CSharp_ECHO_ALL})
endif()

if(NOT CMAKE_CSharp_CREATE_STATIC_LIBRARY)
	set(CMAKE_CSharp_CREATE_STATIC_LIBRARY ${CMAKE_CSharp_ECHO_ALL})
endif()

if(NOT CMAKE_CSharp_COMPILE_OBJECT)
	set(CMAKE_CSharp_COMPILE_OBJECT ${CMAKE_CSharp_ECHO_ALL})
endif()

if(NOT CMAKE_CSharp_LINK_EXECUTABLE)
	set(CMAKE_CSharp_LINK_EXECUTABLE ${CMAKE_CSharp_ECHO_ALL})
endif()
